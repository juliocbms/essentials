...
public interface UserControllerDocs {
    ...
    ResponseEntity<EntityModel<UserResponse>> updateRoleByUserID(@PathVariable UUID id, @Valid @RequestBody UpdateUserRoleRequest request);
    ...
    ResponseEntity<EntityModel<UserResponse>> updateStatusByUserId(@PathVariable UUID id, @Valid @RequestBody UpdateUserStatusRequest request);
